...
const successPayment = (query) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        const logoBase64 = fs_1.default.existsSync(LOGO_PATH)
            ? `data:image/png;base64,${fs_1.default.readFileSync(LOGO_PATH).toString("base64")}`
            : "";
        yield (0, sendEmail_1.sendEmail)({
            to: updatedBooking.user.email,
            subject: "Your Booking Invoice — SH Tour",
            templateName: "invoice",
            templateData: Object.assign(Object.assign({}, invoiceData), { logoBase64 }),
            attachments: [{
